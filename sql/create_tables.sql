...
CREATE TABLE `academy`  (
                            ...
                            `is_delete` tinyint(3) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '逻辑删除，0未删除，1已删除',
...
CREATE TABLE `skill`  (
                          `id` int(10) UNSIGNED ZEROFILL NOT NULL COMMENT '技能展示id',
                          ...
                          `is_delete` tinyint(0) NULL DEFAULT NULL COMMENT '逻辑删除，0未删除，1已删除',
                          PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `skill_level`  (
                                `id` int(0) NOT NULL COMMENT '技能等级id',
                                `skill_level` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '技能等级',
                                `end` int(0) NULL DEFAULT NULL COMMENT '结束值',
                                `start` int(0) NULL DEFAULT NULL COMMENT '开始值',
                                `is_delete` tinyint(3) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '逻辑删除，0未删除，1已删除',
                                PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
                         ...
                         `student_number` int(0) NULL DEFAULT NULL COMMENT '学生学号',
